    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-dark-bg to-gray-900 rounded-2xl border border-green-500/30 max-w-md w-full p-6 shadow-2xl">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-white mb-2">{t('sellSuccess.title')}</h2>
          <p className="text-gray-300">{t('sellSuccess.subtitle')}</p>
        </div>
        ...
        <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4 mb-6">
          <div className="flex items-center justify-center space-x-3 mb-3">
            ...
            <span className="text-green-400 font-semibold">{t('sellSuccess.addedToBank')}</span>
          </div>
